 ...
 * @brief 消息列表哈希表大小
 */
#ifndef message_LIST_HASH_NUM
#define message_LIST_HASH_NUM 5
#endif
...
typedef struct
{
	...
	message_Pack_t *hash_list[message_LIST_HASH_NUM]; /**< hash表 */
} message_List_t;
...
/// @brief 是否为消息缓存事件类型
#define IS_message_BUFFER_CALLBACK_TYPE(a) ((a) == buffer_full_callback || (a) == buffer_half_full_callback)
