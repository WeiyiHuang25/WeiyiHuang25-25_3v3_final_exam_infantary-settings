...
void DJI_Motor_Speed_Loop_Init(Dji_Motor_t *motor, SISO_Controller_t *speed_controller)
{
	...
	Motor_Speed_Loop_Config(&motor->motor, (Motor_Send_Data_t)Motor_Speed_Loop_Controller, speed_controller);
}
